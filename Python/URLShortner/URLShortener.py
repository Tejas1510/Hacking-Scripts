...
shortened_url = Label(window, textvariable=str_url, font=("TimesNewRoman","16"), fg="#fff", bg="#1abc9c")
...
copy_btn = Button(window, text="Copy", bg="#34495e", fg="#fff", font=("TimesNewRoman","12"), command=copy_short_url)
...
btn = Button(window, text="Shorten Url", padx=8, pady=4, bg="#2ecc71", fg="#fff", font=("TimesNewRoman","16"), activebackground="#16a085", command=short_url)
