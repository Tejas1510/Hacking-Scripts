# ✔ NEW PYTHON IDE
- ### A "New Python IDE" is an python IDE created in python with tkinter gui.
...
- ### User just need to download the file and run the new_python_ide.py on their local system.
