...
class instaBot:
    def __init__(self, username, password):
        ...
        usernamefield = self.driver.find_element_by_xpath('//*[@id="loginForm"]/div/div[1]/div/label/input')
        usernamefield.send_keys(username)

        passwordfield = self.driver.find_element_by_xpath('//*[@id="loginForm"]/div/div[2]/div/label/input')
        ...
        self.driver.find_element_by_xpath('/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[5]/div[2]/div[2]/div[2]/a[1]/div/div[2]/div/div/div').click()
    ...
    def get_names(self):
        ...
        trash = ['Edit Profile', 'POSTS', 'IGTV', 'SAVED', 'TAGGED', 'ABOUT', 'HELP', 'PRESS', 'API', 'JOBS', 'PRIVACY', 'TERMS', 'LOCATIONS', 'TOP ACCOUNTS', 'HASHTAGS']
