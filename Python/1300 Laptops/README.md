# ✔ 1300 LAPTOPS
- ### A "1300 Laptop " is an application created in python with tkinter gui.
...
- ### User just need to download the file and run the 1300_laptops.py on their local system.
