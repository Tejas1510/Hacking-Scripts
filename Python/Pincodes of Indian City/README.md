...
- ### In this application, user can get No. of cities in selected district, Range of Pin Code of those cities and the state name.
...
- ### Also there is a ABOUT button, clicking on which user can see about What is Pin Code and when was it imoplemented.
