...
display_width=800
display_height=600
gameDisplay = pygame.display.set_mode((display_width,display_height)) #creating the game room   
...
def gameLoop():
    gameExit = False
    gameOver = False 
    lead_x=display_width/2 #snake is made of blocks,so we r specifying the positon of leading block
